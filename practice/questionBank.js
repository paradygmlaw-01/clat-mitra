...
const questions = [
  ...
  // ── CONTRACT ──
  {
    ...
    correctAnswer: "C",
    explanation: "Sonu changed the price from Rs.30,000 to Rs.28,000, making his reply a counter-offer per the Principle. The original offer stands rejected. Option A ignores that the acceptance was conditional. Option B incorrectly treats silence as acceptance. Option D introduces a writing requirement not in the Principle."
  },
  {
    id: "CON-02",
    subject: "Contract",
